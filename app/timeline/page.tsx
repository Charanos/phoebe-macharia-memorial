      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            A journey through the beautiful moments and milestones of Phoebe's life
          </p>
        </motion.div>
        ...
        {sortedEvents.length === 0 && (
          ...
          >
            ...
            <h3 className="text-xl text-gray-300 mb-2">No events found</h3>
            <p className="text-gray-400">
              {selectedCategory === 'all' 
                ? 'Timeline events will be added soon.' 
                : `No events found in the ${categories.find(c => c.id === selectedCategory)?.label} category.`}
            </p>
          </motion.div>
        )}
      </div>
